...
![[Pasted image 20240214081434.png|400]]
...
![[Pasted image 20240214082521.png]]
**Smart List:**
![[Pasted image 20240214082322.png]]
**Flow:**
![[Pasted image 20240214082826.png]]
### B - Region Change
...
![[Pasted image 20240214084205.png]]
**Flow:**
![[Pasted image 20240214084830.png]]
...
**Smart List:**
![[Pasted image 20240214085813.png]]
**Flow:**
![[Pasted image 20240214085831.png]]
...
**Smart List:**
![[Pasted image 20240214090816.png]]
**Flow:**
![[Pasted image 20240214090834.png]]
...
**Smart List:**
![[Pasted image 20240214092519.png]]

**Flow:**
![[Pasted image 20240214092536.png]]
...
**Smart List:
![[Pasted image 20240214092942.png]]**
**Flow:**
![[Pasted image 20240214103103.png]]
...
![[Pasted image 20240214103825.png]]
**Flow:**
![[Pasted image 20240214103904.png]]
...
**Smart List:**
*Advanced Filter Logic: 1 and (2 or 3)*
![[Pasted image 20240214104935.png]]
**Flow:**
![[Pasted image 20240214105006.png]]
...
**Flow:**
![[Pasted image 20240214111741.png]]
...
![[Pasted image 20240214112601.png]]
#### 180 - Opt-Out: No Consent

`Unsubcribed` = True *and* `Unsubscribed Reason` = `Privacy Compliance`
![[Pasted image 20240214113029.png]]
...
![[Pasted image 20240214113249.png]]
...
![[Pasted image 20240214113449.png|400]]
### 02a. Opt-in
**Smart List:**
*Advanced Filter Logic: 1 or (2 and 3
![[Pasted image 20240216121043.png]]
...
**Smart List:**
*Advanced Filter Logic: 1 and (2 or 3)*
![[Pasted image 20240216121243.png]]
#### Inferred Country List
Anonymous Proxy
Satellite Provider
Unknown
...
**Smart List:**
![[Pasted image 20240216121357.png]]
**Flow:** 
![[Pasted image 20240216121420.png]]

### 210 - Opt-In: Explicit Consent Captured
**Smart List:**
![[Pasted image 20240216121540.png]]
**Flow:**
![[Pasted image 20240216121559.png]]
...
![[Pasted image 20240216121631.png]]
**Flow:**
![[Pasted image 20240216121931.png]]

### 280 - Opt-In: No Consent
**Smart List:**
*Advanced Filter Logic: 1 and (2 or 3)*
![[Pasted image 20240216123011.png]]
**Flow:**
![[Pasted image 20240216123041.png]]
...
![[Pasted image 20240216123907.png]]
...
![[Pasted image 20240216124133.png]]
### 200 - Static Lists
* 210 - Opt-In: Explicit Consent Captured
* 220 - Opt-In: Implied Consent - Legacy
* 280 - Opt-In: No Consent
...
![[Pasted image 20240216131612.png]]
### 03. Double Opt-In

**Smart List:**
*Advanced Filter Logic: 1 or (2 and 3)*
![[Pasted image 20240216131209.png]]
### 300 - DOI: Controller
**Smart List:**
![[Pasted image 20240216131449.png]]
**Flow:**
![[Pasted image 20240216131635.png]]
### 310 - DOI: Initial Explicit Consent Captured
**Smart List:**
![[Pasted image 20240216132825.png]]
**Flow:**
![[Pasted image 20240216132859.png]]
### 311 - DOI: Send Double Opt-In Email
**Smart List:**
![[Pasted image 20240216133219.png]]
**Flow:**
![[Pasted image 20240216133244.png]]
...
**Smart List:**
![[Pasted image 20240216134017.png]]
**Flow:**
![[Pasted image 20240216134051.png]]
...
**Smart List:**
![[Pasted image 20240220122850.png]]
**Flow:**
![[Pasted image 20240220122926.png]]
### 380 - DOI: No Consent
...
**Smart List:**
![[Pasted image 20240220123301.png]]
**Flow:**
![[Pasted image 20240220123328.png]]
### 390 - DOI: ERROR
...
![[Pasted image 20240220124229.png]]
...
![[Pasted image 20240220124309.png|300]]
![[Pasted image 20240220124513.png]]
![[Pasted image 20240220124458.png]]
![[Pasted image 20240220124527.png]]
...
![[Pasted image 20240220124819.png]]
![[Pasted image 20240220124841.png]]
### 300 Static Lists
...
- 380 - DOI: No Consent
- 390 - DOI: ERROR
![[Pasted image 20240220124956.png|300]]
...
**Smart List:**
![[Pasted image 20240220125123.png]]
**Flow:**
![[Pasted image 20240220125139.png]]
...
**Smart List:**
![[Pasted image 20240220125509.png]]
Reason Not Contains: 
`Privacy Compliance
...
**Flow:**
![[Pasted image 20240220125726.png]]
### 440 - Durable Unsubscribe Correction
**Smart List:**
![[Pasted image 20240220125902.png]]
Reason is:
`System flow action sysActionChangeDataValue resetLeadEmailStatus
`System flow action sysActionChangeDataValue updateLeadEmailStatus
`System flow action sysActionChangeDataValue updatePersonEmailStatus
...
![[Pasted image 20240220130401.png]]
![[Pasted image 20240220130443.png]]
...
![[Pasted image 20240220131135.png]]
![[Pasted image 20240220131237.png]]
...
![[Pasted image 20240220131525.png]]
![[Pasted image 20240220131537.png]]
